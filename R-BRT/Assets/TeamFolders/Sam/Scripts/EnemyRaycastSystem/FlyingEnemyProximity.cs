...
public class FlyingEnemyProximity : MonoBehaviour
{
    [Header("Game Objects")]
    ...
    [Header("Scripts")]
    [SerializeField] FlyingBotHeadRaycastDetection flyingBotDetection;
    ...
    private void Update()
    {
        if (playerWithinRange && flyingBotDetection.ReturnPlayerDetected() == false)
        {
    ...
    public void OnTriggerExit(Collider other)
    {
        if (other.gameObject.tag == "Player")
        {
            ...
            flyingBotDetection.SetPlayerDetected(false);
        }
    }
